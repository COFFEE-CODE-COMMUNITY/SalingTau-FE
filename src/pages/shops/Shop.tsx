...
import { Search, ShoppingCart, Star, Sparkles, Bookmark, Eye, List, ChevronRight, X } from 'lucide-react';

const cartItems = [
  { id: 1, name: 'Badge: "Early Bird"', price: 50000, image: 'https://cdn-icons-png.flaticon.com/512/3176/3176298.png' },
  { id: 2, name: 'Badge: "Top Contributor"', price: 125000, image: 'https://cdn-icons-png.flaticon.com/512/860/860228.png' },
  { id: 3, name: 'Badge: "Hackathon 2025"', price: 75000, image: 'https://cdn-icons-png.flaticon.com/512/5732/5732997.png' },
];
...
export default function Shop() {
  ...
  return (
    <>
        ...
        <div className="h-16 flex items-center justify-between px-6">
          {isSearchOpen ? (
            <div className="flex items-center w-full animate-fade-in">
              <input
                type="text"
                placeholder="Cari badge di sini..."
                className="w-full bg-transparent focus:outline-none text-gray-700"
                autoFocus
              />
              <button onClick={() => setIsSearchOpen(false)} className="p-2 rounded-full hover:bg-gray-100 transition-colors">
            ...
            <>
              ...
              <div className="flex items-center space-x-4">
                ...
                <button onClick={() => setIsCartOpen(!isCartOpen)} className="relative p-2 rounded-full hover:bg-gray-100 transition-colors">
      ...
      {/* Cart Dropdown */}
      {isCartOpen && (
        <div className="absolute top-16 right-6 w-80 bg-white border border-gray-200 rounded-lg shadow-lg z-20 animate-fade-in-down">
          <div className="p-4 border-b">
            <h3 className="text-lg font-semibold text-gray-800">Keranjang Belanja</h3>
          </div>
          ...
          <div className="p-4 max-h-64 overflow-y-auto">
            {cartItems.length > 0 ? (
              ...
              <p className="text-sm text-center text-gray-500">Keranjangmu kosong.</p>
            )}
          </div>
          ...
          {cartItems.length > 0 && (
            <div className="p-4 border-t bg-gray-50">
              <div className="flex justify-between items-center mb-4">
                <span className="text-base font-semibold text-gray-800">Subtotal</span>
      ...
      <div className="p-8">
        ...
        <div className="flex items-center space-x-4 mb-8">
          <div className="flex-1 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            <a href="#" className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden group transition-all hover:shadow-lg hover:-translate-y-1">
            <div className="relative bg-gray-200">
              <img className="h-52 w-full object-contain p-4" src="https://cdn-icons-png.flaticon.com/512/3176/3176298.png" alt="Badge Image" />
              <span className="absolute top-2 left-2 bg-purple-500 text-white text-xs font-bold px-2 py-1 rounded">LIMITED</span>
            </div>
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden group transition-all hover:shadow-lg hover:-translate-y-1">
            <div className="relative bg-gray-200">
              <img className="h-52 w-full object-contain p-4" src="https://cdn-icons-png.flaticon.com/512/2928/2928928.png" alt="Badge Image" />
            </div>
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden group transition-all hover:shadow-lg hover:-translate-y-1">
            <div className="relative bg-gray-200">
              <img className="h-52 w-full object-contain p-4" src="https://cdn-icons-png.flaticon.com/512/860/860228.png" alt="Badge Image" />
            </div>
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden group transition-all hover:shadow-lg hover:-translate-y-1">
            <div className="relative bg-gray-200">
              <img className="h-52 w-full object-contain p-4" src="https://cdn-icons-png.flaticon.com/512/5732/5732997.png" alt="Badge Image" />
              <span className="absolute top-2 left-2 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded">EVENT</span>
            </div>
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden group transition-all hover:shadow-lg hover:-translate-y-1">
            <div className="relative bg-gray-200">
              <img className="h-52 w-full object-contain p-4" src="https://cdn-icons-png.flaticon.com/512/10005/10005011.png" alt="Badge Image" />
            </div>
            <div className="p-4">
